...
class LazyListScreen : ComponentActivity() {
...
fun MyLazyListApp(
    ...
    Surface(modifier) {
        if (shouldShowOnboarding) {
            OnboardingScreenLazyList(onContinueClicked = { shouldShowOnboarding = false })
        } else {
            LazyList()
        }
    }
...
@Composable
fun OnboardingScreenLazyList(onContinueClicked: () -> Unit, modifier: Modifier = Modifier) {
